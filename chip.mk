...
ifeq ($(__CONFIG_XR808_SUB_TYPE), st)
  CONFIG_SYMBOLS += -D__CONFIG_XR808_SUB_TYPE_ST
else ifeq ($(__CONFIG_XR808_SUB_TYPE), ct)
  CONFIG_SYMBOLS += -D__CONFIG_XR808_SUB_TYPE_CT
endif
endif
